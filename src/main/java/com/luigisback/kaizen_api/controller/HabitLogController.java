...
public class HabitLogController {
    ...
    public HabitLog createHabitLog(@Valid @RequestBody HabitLog habitLog) {
        return habitLogService.saveHabitLogs(habitLog);
    }
    ...
    public void deleteHabitLogs(@PathVariable Long id){
